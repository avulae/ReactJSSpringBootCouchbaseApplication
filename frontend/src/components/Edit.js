...
class Edit extends Component {
  ...
  onSubmit = (e) => {
    ...
    axios.put('/customer/'+this.props.match.params.id, { name, address, city, postalCode, phone })
      .then((result) => {
          ...
          <div class="panel-body">
            ...
            <form onSubmit={this.onSubmit}>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="phone" value={this.state.customer.phone} onChange={this.onChange} placeholder="Phone Number" />
              </div>
              <div class="form-group">
                <label for="description">Email:</label>
                <input type="email" class="form-control" name="email" value={this.state.customer.email} onChange={this.onChange} placeholder="Email Address" />
              </div>
