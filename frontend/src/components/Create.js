...
class Create extends Component {
  ...
  onSubmit = (e) => {
    ...
    axios.post('/customers', { name, address, city, phone, email })
      .then((result) => {
      ...
      <div class="container">
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <h4><Link to="/"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span> Customers List</Link></h4>
            <form onSubmit={this.onSubmit}>
              ...
              <div class="form-group">
                <label for="published_date">Contact Number:</label>
                <input type="text" class="form-control" name="phone" value={phone} onChange={this.onChange} placeholder="Contact Number" />
              </div>
              <div class="form-group">
